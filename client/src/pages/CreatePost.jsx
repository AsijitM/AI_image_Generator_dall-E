...
const CreatePost = () => {
    ...
    if (form.prompt) {
      try {
        ...
        const response = await fetch(
          'https://dalle-image-generator.onrender.com/api/v1/dalle',
          {
            method: 'POST',
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        const response = await fetch(
          'https://dalle-image-generator.onrender.com/api/v1/post',
          {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
  ...
  return (
    <section className=" max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-sm[500px]">
          Create of imaginative and visually stunning images through by DALL-E
